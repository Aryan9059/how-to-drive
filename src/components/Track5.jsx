// Track5 — Volcanic Blaze
// Dark basalt circuit beside an active lava gorge. Glowing rock walls, orange fog.
...
// Visual road (no physics collider needed — ground handles vertical)
...
// Glowing lava crack (visual only)
...
// Volcanic rock pillar (visual + point light source)
...
const Track5 = () => {
  ...
  return (
    <>
      ...
      {/* ── Lava gorge interior (glowing, visual only) ── */}
      ...
      {/* Lava surface cracks radiating from center */}
      ...
      {/* ── Road edge lava cracks (lane guides) ── */}
      {[-16,-8,0,8,16].map((x,i) => (
      ...
      {/* ── Lava vents on inner walls (ambient light drips) ── */}
      {[-10, 0, 10].map((x, i) => (
