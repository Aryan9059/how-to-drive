...
const TrackLesson8 = () => {
  ...
  return (
    <>
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[50, 0, -3]} receiveShadow>
      ...
      <StaticBox
        position={[hillRun / 2 + 15, hillRise / 2, -3]}
        args={[hillRun + 2, 0.5, 12]}
        rotation={[hillAngle, 0, 0]}
        color="#333"
      />

      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[hillRun + 15 + 40, hillRise + 0.01, -3]} receiveShadow>
        <planeGeometry args={[80, 12]} />
        <meshStandardMaterial color="#2c2c2c" roughness={0.9} />
      </mesh>

      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[14, 0.02, -3]}>
      ...
      <StaticBox position={[hillRun / 2 + 15, hillRise / 2 + 0.8, 5.8]} args={[hillRun + 2, 0.5, 0.2]} rotation={[hillAngle, 0, 0]} color="#dddddd" />
      <StaticBox position={[hillRun / 2 + 15, hillRise / 2 + 0.8, -11.8]} args={[hillRun + 2, 0.5, 0.2]} rotation={[hillAngle, 0, 0]} color="#dddddd" />

      <mesh position={[hillRun / 2 + 15, hillRise / 4, -3]} rotation={[hillAngle + Math.PI / 2, 0, 0]} receiveShadow>
