/**
 * TrackPlane4.jsx – Aerobatics Challenge
 * Plane starts at (0,10,0) facing +X. 6 gate rings arranged in 3-D:
 *   Gate 1: [80,20,0]   – low ahead
 *   Gate 2: [160,50,0]  – high climb
 *   Gate 3: [240,35,40] – bank right (+Z)
 *   Gate 4: [320,60,-40]– bank left (-Z) and high
 *   Gate 5: [380,30,0]  – dive back to centre
 *   Gate 6: [440,20,0]  – final approach, level
 * Numbers painted on the ground indicate gate sequence.
 */
...
const TrackPlane4 = () => (
  <>
    ...
    {/* ── GROUND NUMBER MARKERS (show gate sequence) ── */}
    {GATE_DATA.map(({ pos, color }, i) => (
      <group key={`nm${i}`} position={[pos[0], 0.03, pos[2]]}>
        {/* Coloured disc under each gate */}
    ...
    {/* ── CONNECTING FLIGHT PATH GUIDE LIGHTS ── */}
    {/* Thin trail of small spheres at mid-altitude between gates */}
    {[
    ...
    {/* ── AMBIENT SCENE DETAIL – wind turbines in distance ── */}
