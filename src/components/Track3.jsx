// Night City Circuit — procedural tight street track with neon walls
...
const Track3 = () => {
  // Layout: outer ±22 x ±15, inner hole ±13 x ±6, track width ~9
  return (
    <>
      {/* ── Night sky ground ── */}
      ...
      {/* ── Outer building walls (tall, dark with neon tops) ── */}
      ...
      {/* ── Chicane walls (technical S-bend on straights) ── */}
      {/* South straight chicane */}
